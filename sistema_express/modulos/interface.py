...
# No APK usamos saída simples para evitar incompatibilidades de terminal/Rich
# dentro da interface Kivy. No Termux, Rich continua funcionando normalmente.
if os.environ.get("SISTEMA_EXPRESS_APK") == "1":
    RICH_OK = False
    Console = None
    Group = Panel = Table = Prompt = box = Text = Align = Columns = None
else:
    try:
